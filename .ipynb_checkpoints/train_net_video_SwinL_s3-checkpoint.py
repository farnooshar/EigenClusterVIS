...
def main(args):
    cfg = setup(args)
        ...
        # Make the cfg mutable
    #cfg.defrost()

    # Set the checkpoint period
    #cfg.CHECKPOINT_PERIOD = 10

    # Freeze the cfg if needed later
    #cfg.freeze()
    ...
    # Iterate over model parameters and print their names and shapes
    ...
    trainer.model.load_state_dict(torch.load('/home/user01/MaskFreeVIS/mfvis_models/model_final_swinl_0560.pth')['model'])
